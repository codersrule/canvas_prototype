...
export function GradesPage() {
  ...
  const overallGPA =
    validGrades.length > 0
      ? (
          validGrades.reduce((sum, g) => sum + gradeToGPA(g), 0) /
          validGrades.length
        ).toFixed(2)
      : "0.00";
  ...
  return (
    <div className="grades-page p-6">
      ...
      <div className="space-y-4">
        {courseSummaries.map(
          ({ course, details, effectiveAssignments, currentGrade }) => {
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4 flex-1">
                      <div
                        className={`w-1 h-16 bg-linear-to-b ${course.color} rounded-full`}
                      />
                      ...
                      <div className="hidden md:block w-48">
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div
                            className={`progress-bar bg-linear-to-r ${course.color} h-2 rounded-full`}
