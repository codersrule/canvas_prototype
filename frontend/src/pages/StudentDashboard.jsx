...
function TodoItem({ todo, isLast }) {
  const content = (
    <>
      <div className="text-xs font-semibold text-gray-600 mb-1">{todo.courseCode}</div>
  ...
  const href = courseId != null && todo.assignmentId != null
  ...
  const content = (
    <>
      <div className="text-sm font-semibold text-gray-700 mb-1 flex items-center justify-between">
        ...
        {!announcement.read && <span className="w-2 h-2 bg-gray-600 rounded-full" />}
      </div>
    ...
    <div className="p-6">
      <div className="bg-gradient-to-r from-gray-700 to-gray-600 text-white rounded-xl p-6 mb-6 shadow-md">
        ...
        <p className="text-gray-300">
          You have {upcomingCount} assignment{upcomingCount !== 1 ? 's' : ''} due this week
        </p>
      </div>
        ...
        <div className="space-y-6">
          ...
          <Link href="/calendar">
            ...
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-700">November 2025</h3>
            </div>
            <div className="grid grid-cols-7 gap-1 text-center text-sm">
              ...
              <div className="py-2 bg-gray-600 text-white rounded-full">2</div>
